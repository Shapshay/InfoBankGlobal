...
"g"),Xa=/[',$ВЈв‚¬ВҐ%\u2009\u202F\u20BD\u20a9\u20BArfk]/gi,M=function(a){return!a||!0===a||"-"===a?!0:!1},Pb=function(a){var b=parseInt(a,10);return!isNaN(b)&&isFinite(a)?b:null},Qb=function(a,b){Ya[b]||(Ya[b]=RegExp(va(b),"g"));return"string"===typeof a&&"."!==b?a.replace(/\./g,"").replace(Ya[b],"."):a},Za=function(a,b,c){var d="string"===typeof a;if(M(a))return!0;b&&d&&(a=Qb(a,b));c&&d&&(a=a.replace(Xa,""));return!isNaN(parseFloat(a))&&isFinite(a)},Rb=function(a,b,c){return M(a)?!0:!(M(a)||"string"===
...
oPaginate:{sFirst:"Первая",sLast:"Последняя",sNext:"След.",sPrevious:"Пред."},sEmptyTable:"Отсутствуют данные в таблице",sInfo:"Записи с _START_ по _END_ из _TOTAL_",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Показать по _MENU_",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Найти:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Записей ненайдено !"},oSearch:h.extend({},
