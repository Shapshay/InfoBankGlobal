...
function edtVal(id){
	$.post("modules/complex/item.php", {id:id}, 
		function(data){
			//alert(data);
			...
			if(obj.result=='OK'){
				...
				$('#dostup_start').val(obj.dostup_start);
				$('#dostup_start_display').val(obj.dostup_start);
				$('#dostup_end').val(obj.dostup_end);
				$('#dostup_end_display').val(obj.dostup_end);
				$('#tasks2').html(obj.tasks);
...
function delVal(id){
	swal({   
		 ...
		 function(){   
			$.post("modules/complex/del.php", {id:id}, 
				function(data){
					var obj = jQuery.parseJSON(data);
					if(obj.result=='OK'){
...
function saveVal(){
	...
	$.post("modules/complex/save.php", {id:id, title:title, dostup_start:dostup_start, dostup_end:dostup_end, order:order, block:block, pause:pause},
		function(data){
			//alert(data);
			var obj = jQuery.parseJSON(data);
			if(obj.result=='OK'){
