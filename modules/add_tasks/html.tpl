...
function edtVal(id){
	$.post("modules/add_tasks/item.php", {id:id},
		function(data){
			//alert(data);
...
function delVal(id){
	swal({   
		 ...
		 function(){   
			$.post("modules/add_tasks/del.php", {id:id},
				function(data){
					var obj = jQuery.parseJSON(data);
					if(obj.result=='OK'){
...
function saveVal(){
	...
	$.post("modules/add_tasks/save.php", {id:id, title:title, time_on_task:time_on_task, order:order},
			function(data){
				//alert(data);
				var obj = jQuery.parseJSON(data);
				if(obj.result=='OK'){
...
<script type="text/javascript">
	...
	function ArtListChoise(ch_id) {
		$('#tasks').html('');
		$.post("modules/add_tasks/art_list.php", {ch_id:ch_id},
				function(data){
					//alert(data);
					var obj = jQuery.parseJSON(data);
					if(obj.result=='OK'){
